...
##  runDrawBkg2018.sh
##
##  Runs DrawBackground.cc on all 2018 (data and MC) samples
##
...
do
    root.exe -q -b "../macros/DrawBackground.cc(\"$suffix\", \"2018\")"
    root.exe -q -b "../macros/DrawBackground.cc(\"$suffix\", \"2018\", kTRUE)"
done

...
C     
C     Process: u u~ > z > mu+ mu- mu+ mu- WEIGHTED<=6 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV2_3_3(W(1,1),W(1,2),GC_81,GC_77,MDL_MZ,MDL_WZ,W(1,7))
      CALL FFV1_3(W(1,3),W(1,4),GC_14,MDL_MUB,MDL_WUB,W(1,2))
      CALL FFV2_3_2(W(1,5),W(1,7),GC_82,GC_78,MDL_MMU,ZERO,W(1,1))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,1),W(1,6),W(1,2),GC_14,AMP(1))
      CALL FFV2_3_1(W(1,6),W(1,7),GC_82,GC_78,MDL_MMU,ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,8),W(1,2),GC_14,AMP(2))
      CALL FFV1_3(W(1,3),W(1,6),GC_14,MDL_MUB,MDL_WUB,W(1,2))
      CALL FFV2_3_1(W(1,4),W(1,7),GC_82,GC_78,MDL_MMU,ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,5),W(1,9),W(1,2),GC_14,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,1),W(1,4),W(1,2),GC_14,AMP(4))
      CALL FFV1_3(W(1,5),W(1,4),GC_14,MDL_MUB,MDL_WUB,W(1,2))
      CALL FFV2_3_2(W(1,3),W(1,7),GC_82,GC_78,MDL_MMU,ZERO,W(1,1))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,1),W(1,6),W(1,2),GC_14,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,3),W(1,8),W(1,2),GC_14,AMP(6))
      CALL FFV1_3(W(1,5),W(1,6),GC_14,MDL_MUB,MDL_WUB,W(1,2))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,1),W(1,4),W(1,2),GC_14,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,3),W(1,9),W(1,2),GC_14,AMP(8))

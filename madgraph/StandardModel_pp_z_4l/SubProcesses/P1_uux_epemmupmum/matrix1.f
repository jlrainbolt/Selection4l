...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3_3(W(1,1),W(1,2),GC_79,GC_75,MDL_MZ,MDL_WZ,W(1,9))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFS1_2_3(W(1,1),W(1,2),GC_132,GC_132,MDL_MH,MDL_WH,W(1,12))
...
C     Amplitude(s) for diagram number 23
      ...
      CALL FFV1_2(W(1,1),W(1,10),GC_2,MDL_MU,ZERO,W(1,5))
C     Amplitude(s) for diagram number 24
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,14),GC_79,GC_75,AMP(24))
      CALL FFV2_3_2(W(1,1),W(1,14),GC_79,GC_75,MDL_MU,ZERO,W(1,5))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,5),W(1,2),W(1,10),GC_2,AMP(25))
      CALL FFV2_3_2(W(1,1),W(1,8),GC_79,GC_75,MDL_MU,ZERO,W(1,10))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,10),W(1,2),W(1,15),GC_2,AMP(26))
      CALL FFV1_2(W(1,1),W(1,15),GC_2,MDL_MU,ZERO,W(1,3))
C     Amplitude(s) for diagram number 27
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,8),GC_79,GC_75,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,14),GC_79,GC_75,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,8),GC_79,GC_75,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFS1_2_0(W(1,10),W(1,2),W(1,11),GC_132,GC_132,AMP(30))
      CALL FFS1_2_2(W(1,1),W(1,11),GC_132,GC_132,MDL_MU,ZERO,W(1,10))
C     Amplitude(s) for diagram number 31
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,8),GC_79,GC_75,AMP(31))
      CALL FFS1_2_2(W(1,1),W(1,13),GC_132,GC_132,MDL_MU,ZERO,W(1,10))
C     Amplitude(s) for diagram number 32
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,14),GC_79,GC_75,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFS1_2_0(W(1,5),W(1,2),W(1,13),GC_132,GC_132,AMP(33))

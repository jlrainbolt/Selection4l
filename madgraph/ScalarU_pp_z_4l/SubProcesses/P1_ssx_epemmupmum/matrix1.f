...
C     Amplitude(s) for diagram number 27
      ...
      CALL FFS5_2(W(1,1),W(1,11),GC_118,MDL_MS,ZERO,W(1,7))
C     Amplitude(s) for diagram number 28
      CALL FFV2_3_0(W(1,7),W(1,2),W(1,13),GC_80,GC_76,AMP(28))
      CALL FFV2_3_2(W(1,1),W(1,13),GC_80,GC_76,MDL_MS,ZERO,W(1,7))
C     Amplitude(s) for diagram number 29
      CALL FFS5_0(W(1,7),W(1,2),W(1,11),GC_118,AMP(29))
...
C     Amplitude(s) for diagram number 31
      ...
      CALL FFV2_3_2(W(1,1),W(1,8),GC_80,GC_76,MDL_MS,ZERO,W(1,14))
C     Amplitude(s) for diagram number 32
      CALL FFS5_0(W(1,14),W(1,2),W(1,12),GC_118,AMP(32))
      CALL FFS5_2(W(1,1),W(1,12),GC_118,MDL_MS,ZERO,W(1,11))

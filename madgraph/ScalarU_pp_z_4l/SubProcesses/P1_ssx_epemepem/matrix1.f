...
C     ----------
      ...
      CALL FFS5_3(W(1,1),W(1,2),GC_118,MDL_MH,MDL_WH,W(1,7))
...
C     Amplitude(s) for diagram number 54
      ...
      CALL FFS5_2(W(1,1),W(1,15),GC_118,MDL_MS,ZERO,W(1,23))
C     Amplitude(s) for diagram number 55
      CALL FFV2_3_0(W(1,23),W(1,2),W(1,19),GC_80,GC_76,AMP(55))
      CALL FFV2_3_2(W(1,1),W(1,19),GC_80,GC_76,MDL_MS,ZERO,W(1,23))
C     Amplitude(s) for diagram number 56
      CALL FFS5_0(W(1,23),W(1,2),W(1,15),GC_118,AMP(56))
...
C     Amplitude(s) for diagram number 58
      ...
      CALL FFV2_3_2(W(1,1),W(1,8),GC_80,GC_76,MDL_MS,ZERO,W(1,18))
C     Amplitude(s) for diagram number 59
      CALL FFS5_0(W(1,18),W(1,2),W(1,20),GC_118,AMP(59))
      CALL FFS5_2(W(1,1),W(1,20),GC_118,MDL_MS,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 64
      ...
      CALL FFS5_2(W(1,1),W(1,12),GC_118,MDL_MS,ZERO,W(1,23))
C     Amplitude(s) for diagram number 65
      CALL FFV2_3_0(W(1,23),W(1,2),W(1,16),GC_80,GC_76,AMP(65))
      CALL FFV2_3_2(W(1,1),W(1,16),GC_80,GC_76,MDL_MS,ZERO,W(1,23))
C     Amplitude(s) for diagram number 66
      CALL FFS5_0(W(1,23),W(1,2),W(1,12),GC_118,AMP(66))
...
C     Amplitude(s) for diagram number 68
      ...
      CALL FFV2_3_2(W(1,1),W(1,21),GC_80,GC_76,MDL_MS,ZERO,W(1,24))
C     Amplitude(s) for diagram number 69
      CALL FFS5_0(W(1,24),W(1,2),W(1,25),GC_118,AMP(69))
      CALL FFS5_2(W(1,1),W(1,25),GC_118,MDL_MS,ZERO,W(1,12))

...
C     
C     Process: d d~ > z > e+ e- mu+ mu- WEIGHTED<=6 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3_1(W(1,6),W(1,7),GC_82,GC_78,MDL_MMU,ZERO,W(1,1))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,1),W(1,2),GC_14,AMP(2))
      CALL FFV1_3(W(1,5),W(1,6),GC_14,MDL_MUB,MDL_WUB,W(1,1))
      CALL FFV2_3_2(W(1,3),W(1,7),GC_82,GC_78,MDL_ME,ZERO,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,4),W(1,1),GC_13,AMP(3))
      CALL FFV2_3_1(W(1,4),W(1,7),GC_82,GC_78,MDL_ME,ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,3),W(1,6),W(1,1),GC_13,AMP(4))

...
cut1 = "(z1p4.M() > 60) * (z1p4.M() < 120)"
cutstr = "_60-120"

#cut2 = "(zzp4.M() > 60) * (zzp4.M() < 120)"
#cutstr = "_60-120"

#cut2 = "(zzp4.M() > 50) * (zzp4.M() < 150)"
#cutstr = "_50-150"

#cut2 = "(zzp4.M() > 50) * (zzp4.M() < 350)"
#cutstr = "_50-350"

cut2 = "(zzp4.M() > 50) * (zzp4.M() < 550)"
cutstr = "_50-550"
...
for sel in selection:
    ...
    if sel in ["4l", "4m", "2m2e", "4e"]:
        ...
        data[sel] = muTree.GetEntries(cut1) + elTree.GetEntries(cut1)
    ...
    for sel in selection:
        ...
        if (suff == "zz_4l" and sel in ["4l", "4m", "2m2e", "4e"]) or (suff == "zjets_m-50" and sel in ["mumu", "ee"]):
            if sel in ["4l", "4m", "2m2e", "4e"]:
                ...
                tree.Draw("1>>hist", "!hasTauDecay * " + weight + " * " + cut1, "goff")
                sig[sel] = sf * hist.Integral()
                tree.Draw("1>>hist", "!hasTauDecay * " + weight + " * " + weight + " * " + cut1, "goff")
        ...
        if sel in ["4l", "4m", "2m2e", "4e"]:
            ...
            tree.Draw("1>>hist", weight + " * " + cut1, "goff")
            mc_arr[row][sel] = sf * hist.Integral()
            tree.Draw("1>>hist", weight + " * " + weight + " * " + cut1, "goff")
...
if YEAR_STR != "2012" and "mumu" in selection:
    for sel in ["mumu", "ee"]:

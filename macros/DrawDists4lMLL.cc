...
**  DrawDists4lMLL
**
**  Draws UNSCALED distributions for lowered mll cuts sample
*/ 

void DrawDists4lMLL(const TString suffix, const TString year, const bool isBkg = kFALSE)
{
    ...
    TString prefix  = isBkg ? "bkg_mll_" : "mll_";
    ...
    TString inPath  = EOS_PATH + "/Extended/" + year + "_mll_v1/" + inName;

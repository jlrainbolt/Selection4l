...
void DiffDists4l(const TString suffix, const TString year)
{
...
//      make_tuple( "l4eta",    "l4p4.Eta()",    _eta_(_l_(4)), _units,     20,     -2.5,   2.5),
        ...
        make_tuple( "b_ttm",    "b_ttp4.M()",    _m_(_l_("2,3,4")), _GeV,   20,     4,      54),
...
//      make_tuple( "sin_phi_2",    "sin_phi",          _sinphi,    _units, 2,      -1,     1),
        make_tuple( "cos_theta_z1", "cos_theta_z1",     _costheta_(_Z1), _units,20,     -1,     1),
        make_tuple( "cos_theta_z2", "cos_theta_z2",     _costheta_(_Z2), _units,20,     -1,     1),
        make_tuple( "cos_zeta_z1",  "cos_zeta_z1",      _coszeta_(_Z1), _units, 20,     -1,     1),
        make_tuple( "cos_zeta_z2",  "cos_zeta_z2",      _coszeta_(_Z2), _units, 20,     -1,     1),
        make_tuple( "angle_z1leps", "angle_z1leps/3.14",_alpha_(_Z1), _pirad,   20,     0,      1),
        make_tuple( "angle_z2leps", "angle_z2leps/3.14",_alpha_(_Z2), _pirad,   20,     0,      1),
        make_tuple( "angle_z1l2_z2","angle_z1l2_z2/3.14",   _beta,  _units,     20,     0,      1)
    };

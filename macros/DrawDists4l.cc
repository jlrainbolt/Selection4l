...
void DrawDists4l(const TString suffix, const TString year)
{
    ...
    vector<tuple<TString, TString, TString, TString, int, float, float>> v = {
        ...
        make_tuple( "angle_z1leps", "angle_z1leps/3.14",_alpha_(_Z1), _pirad,   10,     0,      1),
        make_tuple( "angle_z2leps", "angle_z2leps/3.14",_alpha_(_Z2), _pirad,   10,     0,      1),
        make_tuple( "angle_z1l2_z2","angle_z1l2_z2/3.14",   _beta,  _units, 10,     0,      1)
    };

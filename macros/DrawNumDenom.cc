...
**  DrawNumDenom
**
**  Draws correctly-weighted numerator and denominator histograms for BF calculation
*/
...
void DrawNumDenom(const TString suffix, bool useScaling = kTRUE)
{
    ...
    unsigned                MM = 0, EE = 1, M4 = 2, ME = 3, EM = 4, E4 = 5;
    TString selection[N] = {"mumu", "ee",   "4m",   "2m2e", "2e2m", "4e"};
    unsigned chanIdx[N] = { 3,      4,      6,      7,      8,      9};
    float lumi[N] = {   MUON_TRIG_LUMI, ELEC_TRIG_LUMI, MUON_TRIG_LUMI, MUON_TRIG_LUMI, 
                        ELEC_TRIG_LUMI, ELEC_TRIG_LUMI};
